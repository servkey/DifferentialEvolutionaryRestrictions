...
public class Random {
    ...
    private float  Rseed;                   /* random seed */
    private double[] oldrand = new double[55];                /* array of 55 temporal random number*/
    private int jrand;                         /* index for the array of random numbers */
    private int rndcalcflag;
    private double rndx2;
    ...
    public void initrandomnormaldeviate()
    {
        rndcalcflag = 1;
    }
    ...
    public double N(double mu,double sigma)
    {
      //andomnormaldeviate();
    ...
    private double randomnormaldeviate()
    {
       // sqrt(), log(), sin(), cos();
      //randomperc();
      double t, rndx1;
    ...
    public float rndreal(float lo ,float hi)
    {
          return((randomperc() * (hi - lo)) + lo);
    }

    /* Get random off and running */
    private void warmup_random(float random_seed)
    {
      int j1, ii;
     ...
     */
    public void setRseed(float aRseed) {
        Rseed = aRseed;
    }
}
